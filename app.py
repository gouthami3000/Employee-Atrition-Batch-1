...
import pandas as pd
import numpy as np
model=joblib.load("Employee Atrition Batch-1/employee_attrition_model.pkl")
label_encoder=joblib.load("Employee Atrition Batch-1/label_encoder.pkl")
feature_columns=joblib.load("Employee Atrition Batch-1/feature_columns.pkl")
